...
contract BSCValidatorSet is IBSCValidatorSet, System, IParamSubscriber, IApplication {
  ...
  uint256 public constant BURN_RATIO_SCALE = 10000;                     // staking tokens 
  ...
  uint256 public constant INIT_SYSTEM_REWARD_RATIO = 1250; // 625/10000 is 1/16      //// need to replace this with 1/7 but is done with 1/8
